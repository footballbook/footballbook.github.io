...
FK Austria Wien • Austria Wien  (AUS)  -- Wien _#austria_{: .key} <br>
{: .team #austria }
SK Rapid Wien • Rapid Wien  (RAP)  -- Wien _#rapid_{: .key} <br>
{: .team #rapid }
Vienna FC 1894 • First Vienna FC 1894  (VIE)  -- Wien _#vienna_{: .key} <br>
{: .team #vienna }
...
FC Liefering  (LIE)  -- Salzburg (Wals-Siezenheim) _#liefering_{: .key} <br>
{: .team #liefering }
FC RB Salzburg • RB Salzburg • Red Bull Salzburg  (RBS)  -- Salzburg (Wals-Siezenheim) _#salzburg_{: .key} <br>
{: .team #salzburg }
